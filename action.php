		...
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				echo '<div class="row">
							...
							<div class="col-md-4">
								<b class="net_total" style="font-size:20px;"> total : Rs </b>
					</div>';
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/lamington/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/lamington/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/lamington/cancel.php"/>
