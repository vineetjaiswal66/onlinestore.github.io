...
if (isset($_POST["type"]) && !empty($_POST["type"])) {
    ...
    $p_st = "Completed";
    $amount = $_POST['amount'];
    foreach ( $amount as $add_amt){
        $add_amt += $add_amt;
    }
    $amt = $add_amt;
    $cm_user_id = $_SESSION["uid"];
    $c_amt = isset($_COOKIE["ta"]) ? $_COOKIE["ta"] : '';
    if ($p_st == "Completed") {
        include_once("db.php");
                ...
                <div class="navbar navbar-inverse navbar-fixed-top">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a href="#" class="navbar-brand">Laminton</a>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <h1>Thankyou </h1>
                                    <hr/>
                                    <p>Hello <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Your cash on delivery process is
